...
To follow my advice set out in \ref{sec:gain_staging}, all you have to
do is stick with the default setting of \textbf{\SI{-10}{dBFS}}.

If you record very dynamic material or have problems getting a clean
signal, you should try the other two settings.  They will add
additional headroom by shifting the scales down by either \SI{5}{dB}
or \SI{10}{dB}.
