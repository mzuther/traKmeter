...
\subtitle{
  \normalsize{\textrm{\textmd{
        ...
        \begin{figure}[H]
          \centering{}
          \includegraphics[scale=0.50,clip]{include/images/trakmeter.png}
        \end{figure}
        \vfill
      }}}
}
...
There is a great thread over at Gearslutz (``The Reason Most ITB mixes
...
% at higher level will almost certainly sound worse (especially when you
% use plug-ins).
...
transient audio sources (drums, percussion, piano) and static ones
(pads, bass).
