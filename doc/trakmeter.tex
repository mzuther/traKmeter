...
Begin by starting \textbf{traKmeter}.  If in a Bash shell, try this:

\path{./trakmeter_stereo 2>&1 | tee /tmp/validation.log}
...
be easy to compile on Mac OS X.  Unfortunately, I happen to not have a
Mac \dots
...
the time of writing, I'm using Linux Mint 17, but the procedure should
