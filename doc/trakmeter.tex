...
\emph{Unfortunately, the underlying JUCE library doesn't seem to
  support multichannel audio files.  Simply load the audio file into
  your DAW of choice and insert \textbf{traKmeter} as a plug-in
  instance.}
