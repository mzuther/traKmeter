...
Again, this number should be familiar: during digital recording, peak
levels shouldn't exceed this level.
...
\SI[addsign=all]{3.01}{\dBFS}).  Similar to a VU meter, the meter
takes \SI{300}{\milli\second} to reach \SI{99}{\percent} of the final
reading.  It exhibits no overshoot, however.
