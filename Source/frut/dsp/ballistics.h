...
#ifndef FRUT_DSP_BALLISTICS_H
#define FRUT_DSP_BALLISTICS_H
...
{
public:
   explicit Ballistics( const int numberOfChannels );
   ~Ballistics();
...
private:
   ...
   JUCE_LEAK_DETECTOR( Ballistics );
};

}
}

#endif  // FRUT_DSP_BALLISTICS_H
