...
Ballistics::Ballistics( const int numberOfChannels )
{
...
void Ballistics::setCoefficients(
   const double a0,
   const double a1,
   const double a2,
...
void Ballistics::processSampleInternal(
   double& sampleValue,
...
void Ballistics::processInPlace(
...
AudioBuffer<double> Ballistics::process(
