...
ifeq ($(config),debug_x32)
  ...
  TARGET = $(TARGETDIR)/traKmeter\ Debug.so
  OBJDIR = ../../../bin/.intermediate_linux/trakmeter_vst3_debug/x32
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -D_DEBUG=1 -DDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=1 -DTRAKMETER_VARIBUS=1 -DJucePlugin_Build_Standalone=0 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=1 -DJUCE_ALSA=0 -DJUCE_JACK=0 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  ...
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname="traKmeter\ Debug.so" -Wl,--no-undefined
...
ifeq ($(config),debug_x64)
  ...
  TARGET = $(TARGETDIR)/traKmeter\ Debug.so
  OBJDIR = ../../../bin/.intermediate_linux/trakmeter_vst3_debug/x64
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -D_DEBUG=1 -DDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=1 -DTRAKMETER_VARIBUS=1 -DJucePlugin_Build_Standalone=0 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=1 -DJUCE_ALSA=0 -DJUCE_JACK=0 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2 -I../../../libraries/vst2/VST2_SDK -I../../../libraries/vst3/VST3_SDK
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname="traKmeter\ Debug.so" -Wl,--no-undefined
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x32)
  ...
  TARGETDIR = ../../../bin/vst3/traKmeter.vst3/Contents/i386-linux
  TARGET = $(TARGETDIR)/traKmeter.so
  OBJDIR = ../../../bin/.intermediate_linux/trakmeter_vst3_release/x32
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -DNDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=0 -DTRAKMETER_VARIBUS=1 -DJucePlugin_Build_Standalone=0 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=1 -DJUCE_ALSA=0 -DJUCE_JACK=0 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2 -I../../../libraries/vst2/VST2_SDK -I../../../libraries/vst3/VST3_SDK
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=traKmeter.so -Wl,--no-undefined
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x64)
  ...
  TARGETDIR = ../../../bin/vst3/traKmeter.vst3/Contents/x86_64-linux
  TARGET = $(TARGETDIR)/traKmeter.so
  OBJDIR = ../../../bin/.intermediate_linux/trakmeter_vst3_release/x64
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -DNDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=0 -DTRAKMETER_VARIBUS=1 -DJucePlugin_Build_Standalone=0 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=1 -DJUCE_ALSA=0 -DJUCE_JACK=0 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2 -I../../../libraries/vst2/VST2_SDK -I../../../libraries/vst3/VST3_SDK
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=traKmeter.so -Wl,--no-undefined
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
